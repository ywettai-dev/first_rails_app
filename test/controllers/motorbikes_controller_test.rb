...
class MotorbikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create motorbike" do
    assert_difference('Motorbike.count') do
      post motorbikes_url, params: { motorbike: { make: @motorbike.make, model: @motorbike.model, year: @motorbike.year } }
    end
  ...
  test "should update motorbike" do
    patch motorbike_url(@motorbike), params: { motorbike: { make: @motorbike.make, model: @motorbike.model, year: @motorbike.year } }
